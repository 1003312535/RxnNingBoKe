    ...
    export default {
        ...
        methods: {
            ...
            comment_submit() {
                ...
                if (this.insert_comment.comment_text === "" || this.insert_comment.comment_name === "") {
                    // console.log("评论为空");
